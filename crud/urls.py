...
urlpatterns = [
    ...
    path('mensaje/apariciones', views.MensajeViewSet.as_view({ 'post': 'users_with_text_in_messages' })),
    path('mensaje/average/social-media', views.MensajeViewSet.as_view({ 'post': 'average_messages_social_media' })),
    path('mensaje/seed/metacritic', views.MensajeViewSet.as_view({ 'post': 'seed_metacritic_mensajes_data' })),
    path('mensaje/more-commented', views.MensajeViewSet.as_view({ 'post': 'stats_more_commented_social_media' })),
